    ...
    <Sheet open={open} onOpenChange={(v) => { if (!v) onClose() }}>
      ...
      >
        ...
        <div className="relative h-56 md:h-64">
          {promotion?.bannerImageUrl || meal?.imageUrl ? (
            <img
          ...
          <div className="absolute bottom-4 right-4 left-4" dir="rtl">
            ...
            <p className="text-white/70 text-sm mt-1">{displayItem!.title}</p>
          </div>
        </div>
        ...
        <div className="p-5 space-y-5" dir="rtl">
          {/* Meal Info */}
          <div>
            <p className="text-white/80 text-sm leading-relaxed">{displayItem!.descriptionAr || displayItem!.description}</p>
                        ...
                        <motion.button
                          ...
                          className={`w-full flex items-center gap-3 rounded-xl p-3 transition-all text-right ${
                            selected
                              ...
                              : 'bg-white/5 border-2 border-transparent hover:border-[#D4AF37]/20 hover:bg-white/[0.08]'
                          }`}
                        >
                          {addon.imageUrl ? (
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {promotion.mealItems.map((mi) => (
                  <div key={mi.id} className="flex items-center gap-3 rounded-xl bg-white/5 border border-white/10 p-3">
                    {mi.meal?.imageUrl ? (
                      <img
