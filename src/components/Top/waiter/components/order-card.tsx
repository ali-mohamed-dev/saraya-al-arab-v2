...
import { 
  ...
  Flame, Coffee, Timer, Hash, ChevronDown, ChevronUp, AlertCircle, Send, PlusCircle
} from 'lucide-react'
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
              {onAddItems && order.status !== 'PENDING' && (
                <Button
                  ...
                  variant="outline"
                  onClick={onAddItems}
                  className="gap-1 border-orange-500/30 text-orange-400 hover:bg-orange-500/10 h-7 sm:h-8 px-2 text-[10px] sm:text-xs font-bold"
                >
